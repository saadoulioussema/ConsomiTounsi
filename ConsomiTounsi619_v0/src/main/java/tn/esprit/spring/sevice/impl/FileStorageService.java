...
import tn.esprit.spring.sevice.interfece.IFileStorageService;
import tn.esprit.spring.utils.AppConstants;
import tn.esprit.spring.utils.FileStorageException;
import tn.esprit.spring.utils.MyFileNotFoundException;
...
public class FileStorageService implements IFileStorageService {
	...
	public String storeFile(MultipartFile file) throws IOException {
		...
		File f = new File("./uploads\\"+file.getOriginalFilename());//AppConstants.TEMP_DIR au lieu de "./uploads\\"
